...
LEAGUE_URL = 'https://www.transfermarkt.co.uk/bundesliga/startseite/wettbewerb/L1'
...
# ステップ1: 全クラブのURLを取得
# ==========================================
puts "【ステップ1】ブンデスリーガのクラブ一覧からバイエルンを取得中..."
...
league_doc.css('table.items > tbody > tr > td.hauptlink > a').each do |link|
  href = link['href']
  if href.include?('startseite/verein') && href.include?('/fc-bayern-munchen/')
